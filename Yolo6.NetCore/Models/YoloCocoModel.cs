...
namespace Yolo6.NetCore.Models
{
    public class YoloCocoModel : YoloModel
    {
        ...
        public override int[] Strides { get; set; } = new[] { 8, 16, 32, 64 };

        public override int[][][] Anchors { get; set; } = new[]
        {
        ...
        public override int[] Shapes { get; set; } = new[] { 160, 80, 40, 20 };
        ...
        public override string[] Outputs { get; set; } = new[] { "outputs" };
